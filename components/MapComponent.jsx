...
const MapComponent = () => {
    ...
    return (
        ...
        >
            ...
            <Marker position={corporateOffice.position} icon={corporateIcon}>
                <Popup className="custom-popup">
                    <div style={{ padding: '8px' }}>
                        <h4 style={{ margin: '0 0 8px 0', fontSize: '16px', fontWeight: '600', color: '#134252' }}>
                            🏢 {corporateOffice.name}
                        </h4>
                        <p style={{ margin: '0 0 8px 0', fontSize: '14px', lineHeight: '1.4', color: '#626C71' }}>
            ...
            <Marker position={manufacturingFacility.position} icon={manufacturingIcon}>
                <Popup className="custom-popup">
                    <div style={{ padding: '8px' }}>
                        <h4 style={{ margin: '0 0 8px 0', fontSize: '16px', fontWeight: '600', color: '#134252' }}>
